<template>
  <div
    class="grid grid-cols-[auto_396px] grid-rows-[56px_auto] gap-y-17 overflow-hidden">
    ...
    <div
      ...
      <house-list-item
        ...
        :key="index"
        :house="house"
        class="mb-20 w-360 h-200"></house-list-item>
    </div>
    <div
      v-else
      class="flex flex-col items-center justify-center bg-yellow-200"></div>
  </div>
</template>
